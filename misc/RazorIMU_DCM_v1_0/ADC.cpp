...
{
     AN[0]= ((Anal_Read(1)*.9)+(AN[0]*.1)); // Gx     Anal means Analog.. 
     AN[1]= ((Anal_Read(0)*.9)+(AN[1]*.1)); // Gy     Maps sensors to correct order 
     AN[2]= ((Anal_Read(2)*.9)+(AN[2]*.1)); // Gz
     AN[3]= ((Anal_Read(5)*.9)+(AN[3]*.1)); // Ax
     AN[4]= ((Anal_Read(4)*.9)+(AN[4]*.1)); // Ay
     AN[5]= ((Anal_Read(3)*.9)+(AN[5]*.1)); // Az
