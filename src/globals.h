...
#define TMIN   420   // Minimum throttle PWM duty cycle. At 400 kHz, 2500*420/1023 = 1026 us, which is actually a bit lower than the actual minumum 2500 * 432/1023 = 1055 us. This is so the position P control response stays low while I carry the tricopter around before takeoff.
